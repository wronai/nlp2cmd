...
*Generated on: 2026-01-27T11:32:23.527008*
...
- **Total Time Saved (10 commands)**: 82.8ms (9.7% efficiency gain)
- **Average Throughput**: 38.91 commands/sec
...
|---------|-------------------|-------------------|-------------------|------------------|----------------|
| SHELL | 29.3 | 25.7 | 257.4 | 38.85 | 35.9 |
| SQL | 29.5 | 25.1 | 251.3 | 39.79 | 43.3 |
| DOCKER | 26.6 | 26.2 | 262.5 | 38.09 | 3.5 |
...
|---------|------------|-------------------|---------------------|-------------|
| SHELL | 35.9 | 25.7 | 257.4 | 28.7 |
| SQL | 43.3 | 25.1 | 251.3 | 34.7 |
| DOCKER | 3.5 | 26.2 | 262.5 | 2.8 |
...
1. **Model Loading Time**
   - Average initialization overhead: 27.6ms
...
3. **Adapter Initialization**
   - Fastest adapter: sql (25.1ms avg)
